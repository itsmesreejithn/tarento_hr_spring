...
CREATE TABLE `ibu` (
  `ibu_id` int NOT NULL,
  `ibu_name` varchar(45) NOT NULL,
  `ibu_manager` varchar(45) NOT NULL,
  PRIMARY KEY (`ibu_id`)
...
INSERT INTO `ibu` VALUES (1,'NXT','Sowbhagya'),(2,'Digital','Mohit'),(3,'EC','Bindu'),(4,'DAA','Amith');
...
--
-- Table structure for table `new_joinee_seq`
--

DROP TABLE IF EXISTS `new_joinee_seq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `new_joinee_seq` (
  `next_val` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `new_joinee_seq`
--

LOCK TABLES `new_joinee_seq` WRITE;
/*!40000 ALTER TABLE `new_joinee_seq` DISABLE KEYS */;
INSERT INTO `new_joinee_seq` VALUES (51);
/*!40000 ALTER TABLE `new_joinee_seq` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `role` VALUES (1,'Associate Software Engineer'),(2,'Software Engineer'),(3,'Senior Software Engineer'),(4,'Associate Architect'),(5,'Architect'),(6,'Manager');
...
-- Dump completed on 2023-12-16 14:44:51
