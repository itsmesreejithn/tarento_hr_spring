...
const Template3 = ({ newJoinee }) => {
  ...
  return (
    <Row className="varient3">
      <Row>
        <Col className="rounded m-1 p-5 bg-black bg-gradient border border-white text-center">
      ...
      <Row>
        ...
        <Col className="m-1 p-5 text-center">
          <Row>
            <Col>
              <p className="rounded m-1 p-5 bg-black bg-gradient border border-white text-center">
                Home Town
              </p>
